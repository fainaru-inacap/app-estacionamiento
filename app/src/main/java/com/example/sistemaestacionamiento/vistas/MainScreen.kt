...
sealed class Screen(val route: String, val label: String, val icon: @Composable () -> Unit) {
    ...
    object History : Screen("history", "Historial", { Icon(Icons.Filled.History, contentDescription = null) })
    object Profile : Screen("profile", "Perfil", { Icon(Icons.Filled.Person, contentDescription = null) })
}

@Composable
fun MainScreen(mainNavController: NavController, auth: FirebaseAuth) {
